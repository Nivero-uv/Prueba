...
| ---------- | ---------- | ---------- |
| Submit an application for data incorporation use cases | Complete the application for data incorporation use cases form for the Access Committee to evaluate the scientific relevance of your participation in EUCAIM as a data holder. | The link to the application form for STK-DHs is not working and it is not included the link to the application form for EUCAIM partners, I’d suggest to include the   following in documents: <br>- If you are a EUCAIM partner: [Call for use cases from EUCAIM partners](https://eu.jotform.com/233524103677050). <br>- If you are a EUCAIM stakeholder: [External application form - Stakeholders - Data Holders](https://form.jotform.com/251552461162350  ).|
